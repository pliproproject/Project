...
def get_user_data(parent, frame_play, frame_top, frame_bottom, frame_game_score, frame_high_scores):
    ...
    def clicked3():
        ...
        category = cat.get()
        play(frame_play, frame_top, frame_bottom, frame_game_score, parent, frame_high_scores, params, username, category)
