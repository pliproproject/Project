...
# Νομίζω ότι η πιο εύκολη προσέγγιση είναι να χρησιμοποιήσουμε frames.
...
# Στο κάτω (frame_button) θα εμφανίζονται τα απαραίτητα buttons ανάλογα με το σημείο που είμαστε
